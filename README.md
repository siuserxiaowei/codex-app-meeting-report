...
- GitHub 仓库 / Repository: https://github.com/siuserxiaowei/codex-app-meeting-report
- Live / 在线入口：https://siuserxiaowei.github.io/codex-app-meeting-report/
- 默认分支 / Default branch: `main`
- 主要语言 / Primary language: `project`
- 可见性 / Visibility: `public`
- 仓库类型 / Repository type: `source`
- Topics / 主题：`agent-coding`, `automation`, `codex-app`, `github-pages`, `meeting-notes`
